...
$(".sMenu").click(function () {
  isTrue
    ? ($(".tabMenu").addClass(" mOpen ").removeClass(" mClose "),
      (nvWidth = $(".tabMenu").width() - 10),
      $(".navBar").css("left", nvWidth),
      $(".fa-align-justify").toggleClass("fa-times"),
      $(".tabMenu .item1").animate(
        {
          opacity: "1",
          paddingTop: "25px",
        },
      ...
      (isTrue = !isTrue))
    : ($(".tabMenu").addClass(" mClose ").removeClass(" mOpen "),
      $(".fa-align-justify").toggleClass("fa-times"),
      $(".navBar").css("left", 0),
      $(".tabMenu li").animate(
        {
...
$(".strip-search").click(function () {
  isSearchTrue
    ? ($(".search").addClass(" mOpen ").removeClass(" cSearch "),
    ...
    : ($(".search").addClass(" cSearch ").removeClass(" mOpen "),
      $(".fa-search").toggleClass("fa-times"),
      $(".searchInput").animate({
        top: "300%",
      }),
...
$(".nav-item a").click(async (e) => {
  ...
  document.querySelector(".sMenu").dispatchEvent(click_event);
...
$(document).scroll((e) => {
  if ($(document).scrollTop()) {
    $(".posation1").css("backgroundColor", "#0D0D0D");
  }
});
